...
const en = {
  ...
  message: {
    ...
    loadImage: (host: string) => (host ? `Load external image (${host})` : "Load external image"),
  },
  gmail: {
    title: "Connect your Gmail",
    description: "Read-only access so EverVault can answer questions about your email and flag important messages.",
    connect: "Connect Gmail",
    connecting: "Finish connecting in the Google window…",
    openInNewTab: "Open Google sign-in",
    connected: "Gmail connected",
    connectedAs: (email: string) => `Connected as ${email}`,
    declined: "You declined — nothing was connected.",
    error: "Connecting didn't work. Please try again.",
    tryAgain: "Try again",
    readOnlyNote: "Read-only. You can disconnect anytime by asking in the chat.",
  },
  settings: {
    title: "Settings",
    close: "Close",
