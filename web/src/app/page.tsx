      ...
      <header className="sticky top-0 z-30 w-full border-b border-black/10 bg-white/70 backdrop-blur-md dark:border-white/10 dark:bg-black/40">
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Link
              href="/webapp"
              className="hidden md:inline-flex items-center gap-1.5 rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
              {t.nav.openApp}
